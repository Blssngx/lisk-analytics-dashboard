...
export async function POST(request: NextRequest){
    try{
        ...
        while(compiledData.cursor){
            ...
            compiledData = {...newData.raw, result: [...compiledData.result,...newData.raw.result ]}
        }
        
        // Process and calculate wallet data from transfers
        const processedData = WalletDataProcessor.processWalletDataFromTransfers(compiledData.result);
