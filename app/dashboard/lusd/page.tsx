    ...
    try {
      switch (queryType) {
        case "cumulativeGrowth":
          await refreshCumulativeGrowth.mutateAsync({ contractAddress: LUSD_CONTRACT })
          break
        case "uniqueWallets":
          await refreshUniqueWallets.mutateAsync({ contractAddress: LUSD_CONTRACT })
          break
        case "weeklyPayments":
      ...
      <DashboardLayout>
        <div className="p-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <div className="flex items-center space-x-3">
                  ...
                  <h1 className="text-3xl font-bold text-white">LUSD Token Analytics</h1>
                </div>
                <p className="text-gray-400 mt-1">Comprehensive analytics for LUSD token on the Lisk network</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <MetricCard title="Total Supply" value={tokenLoading ? "Loading..." : `${tokenData?.totalSupplyFormatted || 'N/A'} LUSD`} subtitle={tokenError ? "Error loading data" : "Fixed supply"} />
          ...
          <div className="space-y-6">
            <ChartCard title="Cumulative Growth" isLoading={loadingStates.cumulativeGrowth || cumulativeGrowthLoading} onRunQuery={() => runQuery("cumulativeGrowth")} cooldownKey="cooldown:cumulative-growth">
              ...
              <ChartAreaInteractive data={cumulativeDisplay} />
            </ChartCard>
